...
class AboutBlocks < EdgeCase::Koan
  ...
  def
test_block_can_affect_variables_in_the_code_where_they_are_created
    value = :initial_value
  ...
  def test_methods_can_take_an_explicit_block_argument
    assert_equal 60, method_with_explicit_block { |n| n * 3 }

    add_one = lambda { |n| n + 1 }
    assert_equal 21, method_with_explicit_block(&add_one)
  end
